         ...
         <tbody>
          ...
          foreach($kelas_kamar as $kk){
            ...
            <tr>
              <td><?php echo $no++; ?></td>
              <td>
                <a  href="<?php echo base_url().'operator/kamar_kelas_edit/'.$kk->id_kelas_kamar; ?>"
                <i class="fa fa-edit"></i></a> &nbsp;
                <a  href="<?php echo base_url().'operator/kamar_kelas_delete/'.$kk->id_kelas_kamar;?>" onclick="return confirm('Yakin Ingin Menghapus ?')"> <i class="fa fa-times"></i></a>
              </td>
