         ...
         <tbody>
          ...
          foreach($kamar as $k){
            ...
            <tr>
              <td><?php echo $no++; ?></td>
              <td>
                <a  href="<?php echo base_url().'operator/kamar_edit/'.$k->id_kamar; ?>"
                <i class="fa fa-edit"></i></a> &nbsp;
                <a  href="<?php echo base_url().'operator/kamar_delete/'.$k->id_kamar;?>" onclick="return confirm('Yakin Ingin Menghapus ?')"> <i class="fa fa-times"></i></a>
              </td>
              <td><?php echo $k->no_kamar; ?></td>
              <td><?php echo rupiah($k->harga_kamar); ?></td>
              <td><?php echo $k->nama_kelas_kamar; ?></td>
              <td>
                <a  class="btn btn-success" href="<?php echo base_url().'operator/kamar_gambar/'.$k->id_kamar?>"><i class="fa fa-image"></i></a>
              </td>
            </tr>
            <?php 
          }
