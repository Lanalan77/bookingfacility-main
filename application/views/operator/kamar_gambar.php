  ...
  <div id="content-wrapper">
    ...
    <?php $this->load->view("operator/_partials/breadcrumb.php") ?>
      ...
      <div class="card mb-3">
        ...
        <form action="<?php echo base_url().'operator/kamar_gambar_tambah_aksi' ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <center>
                      <h3>Nomor Ruangan : <?php echo $no_kamar;  ?> </h3>
                      <h3>Harga Ruangan : <?php echo rupiah($harga_kamar); ?> </h3>
                      <h3>Kelas Ruangan : <?php echo $nama_kelas_kamar ?> </h3>
                      </center>
         ...
         <tbody>
          ...
          foreach($kamar_gambar->result_array() as $tampil){
            ...
            <tr>
              <td><?php echo $no++; ?></td>
              <td>
               <a  href="<?php echo base_url();?>operator/kamar_gambar_delete/<?php echo $tampil['id_kamar_gambar'];?>/<?php echo $tampil['id_kamar'];?>" onclick="return confirm('Yakin Ingin Menghapus?')"> <i class="fa fa-times"></i></a>
              </td>
              <td>
